...
export const QuestionForm = ({
  ...
  return (
    <div className="animated-border bg-gray-800/30 backdrop-blur-sm p-8 rounded-3xl shadow-2xl space-y-6">
      {errors.length > 0 && (
        <div className="bg-red-500/10 border-2 border-red-500/30 rounded-2xl p-4" role="alert">
      ...
      {/* Slug */}
      <div>
        <label className="block text-sm font-medium text-gray-300 mb-2">Question Slug</label>
        <div className="flex gap-2">
          <input
            type="text"
            value={question.question_slug}
            onChange={(e) => onInputChange("question_slug", e.target.value)}
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Write your question description here... Use Markdown for formatting."
        />
      </div>
      ...
      <div>
        ...
        {showConstraintsGuide && (
          <div className="bg-gray-900/50 rounded-xl p-4 mb-3 text-sm text-gray-400 font-mono">
            <p className="mb-2">Example constraints:</p>
            <code className="block text-teal-400 whitespace-pre-line">
              {"1 ≤ n ≤ 10^5\n-10^9 ≤ arr[i] ≤ 10^9\n1 ≤ queries ≤ 10^4"}
            </code>
          </div>
        )}
      ...
      <div className="flex flex-wrap gap-3 pt-4">
        ...
        <button
          onClick={onValidate}
          className="px-6 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-2xl transition-all shadow-lg hover:shadow-blue-500/50 font-medium"
        >
          Validate & Run
        </button>
        ...
        <button
          ...
          className="px-6 py-3 bg-gradient-to-r from-teal-500 to-purple-500 hover:from-teal-600 hover:to-purple-600 text-white rounded-2xl transition-all shadow-lg hover:shadow-teal-500/50 font-medium"
        >
          Publish Question
        </button>
      </div>
