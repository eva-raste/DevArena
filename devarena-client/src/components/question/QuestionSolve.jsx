...
import { fetchAcceptedQuestions } from "../../apis/contest-api";
    ...
    <div className="min-h-screen bg-background text-foreground px-6 py-8 md:px-10">
                        ...
                        <tbody>
                            {mySubmissions.map((s) => (
                                <tr key={s.id} className="border-b last:border-0">
                                    ...
                                    <td
                                        className={`${VERDICT_STYLES[s.verdict] ?? "text-muted-foreground"}`}
                                    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
                ...
                {verdict && (
                    <div
                        className={`mt-4 p-3 rounded ${verdict === "ACCEPTED"
            ...
            <div>
                    ...
                    {allCases.map((tc) => (
                        <div key={tc.caseNumber} className="relative">
                            <button
                                ...
                                className={`px-3 py-1 rounded font-semibold border transition ${selectedCase === tc.caseNumber
                ...
                {currentCase && (
                    <div>
                        ...
                        <pre
                            className={`bg-background p-2 rounded overflow-x-auto text-sm ${currentResult?.stderr
                                ? "text-destructive"
                                : "text-foreground"
                                }`}
                        >
