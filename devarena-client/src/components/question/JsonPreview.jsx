...
export const JsonPreview = ({ question, modifiers = [], onCopy, onPreviewPublish }) => {
  ...
  return (
    <div
      data-theme={theme}
      className="bg-gray-800/20 p-4 rounded-2xl border border-gray-700/30"
    >
      <div className="flex items-center justify-between">
        <div>
          <h4 className="text-lg font-semibold">JSON Preview</h4>
          <p className="text-sm text-gray-400">
            Formatted question payload (including modifiers)
          </p>
        </div>
